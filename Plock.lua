		...
		repeat
			...
			elseif (_G.SelectFast == "Beautiful Pirate") then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5319, 23, -93));
                        elseif (_G.SelectFast == "Tiki Outpost") then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-16813.44, 58.30, 304.87);
                        elseif (_G.SelectFast == "Submerged Islan") then
				game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(11520.80, -2154.98, 9829.51);
			end
